...
export default function Search() {
  ...
  // 🆕 selected venue (for map interaction)
    ...
    <>
      ...
      <section style={{ position: "relative" }}>
        ...
        <div
          style={{
            position: "absolute",
            right: selected ? "auto" : 10,
            bottom: selected ? "auto" : -10,
            left: selected ? "50%" : "auto",
            top: selected ? "35%" : "auto",
            transform: selected ? "translate(-50%, -50%)" : "none",
        ...
        {selected && (
          ...
          >
            <iframe
              ...
              loading="lazy"
              allowFullScreen
              src={`https://www.google.com/maps?q=&layer=c&cbll=${selected.lat},${selected.lng}&cbp=11,0,0,0,0`}
            />
          </div>
        )}
