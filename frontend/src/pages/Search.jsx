...
<> <Header />
  ...
  >
    {/* 🗺️ Map */}
    <MapView venues={displayList} center={{ lat, lng }} />
    ...
    <div
      style={{
        ...
        pointerEvents: "none",
        background:
          "radial-gradient(circle at 30% 30%, rgba(255,255,255,0.35), transparent 40%), radial-gradient(circle at 70% 60%, rgba(255,255,255,0.25), transparent 40%)",
        zIndex: 1,
      }}
    />
